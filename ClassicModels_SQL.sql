...
set @pt1=(select officeLocation from offices where city='Tokyo');
select customername, country, city, ST_Distance_Sphere(@pt1, customerlocation) as distance
from customers
order by distance
limit 1;
-- 4. Which French customer is furthest from the Paris office?
set @pt1=(select officeLocation from offices where city='Paris');
select customername, country, city, ST_Distance_Sphere(@pt1, customerlocation) as distance
from customers
...
set @pt1=(select officeLocation from offices where city='Paris');
set @pt2=(select officeLocation from offices where city='Boston');
